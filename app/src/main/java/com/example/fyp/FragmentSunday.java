...
public class FragmentSunday extends Fragment implements ArrayInterface, WeatherAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        WeatherAdapter weatherAdapter = new WeatherAdapter(getActivity(), sundayData);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(weatherAdapter);
        weatherAdapter.setOnItemClickListener(FragmentSunday.this);
    ...
    public void onItemClick(int position) {
        ...
        Weather clickedWeatherItem = sundayData.get(position);
