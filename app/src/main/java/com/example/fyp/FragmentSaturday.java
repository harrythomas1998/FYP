...
public class FragmentSaturday extends Fragment implements ArrayInterface, WeatherAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        WeatherAdapter weatherAdapter = new WeatherAdapter(getActivity(), saturdayData);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(weatherAdapter);
        weatherAdapter.setOnItemClickListener(FragmentSaturday.this);
    ...
    public void onItemClick(int position) {
        ...
        Weather clickedWeatherItem = saturdayData.get(position);
