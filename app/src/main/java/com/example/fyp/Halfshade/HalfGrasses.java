...
public class HalfGrasses extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_half_grasses);
        ...
        recyclerView = findViewById(R.id.halfGrassesRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchHalfGrasses);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("partial") || position.contains("lightly dappled") || position.contains("light, dappled") || position.contains("Partial Shade") || position.contains("Lightly Dappled") || position.contains("little") || position.contains("dappled")) {
                    ...
                    halfGrassesList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(HalfGrasses.this, halfGrassesList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(HalfGrasses.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = halfGrassesList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = halfGrassesList.get(position);
