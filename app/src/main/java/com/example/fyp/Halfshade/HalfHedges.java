...
public class HalfHedges extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_half_hedges);
        ...
        recyclerView = findViewById(R.id.halfHedgesRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchHalfHedges);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("partial") || position.contains("lightly dappled") || position.contains("light, dappled") || position.contains("Partial Shade") || position.contains("Lightly Dappled") || position.contains("little") || position.contains("dappled")) {
                    ...
                    halfHedgesList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(HalfHedges.this, halfHedgesList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(HalfHedges.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = halfHedgesList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = halfHedgesList.get(position);
