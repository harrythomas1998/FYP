...
public class HalfClimbers extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_half_climbers);
        ...
        recyclerView = findViewById(R.id.halfClimbersRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchHalfClimbers);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("partial") || position.contains("lightly dappled") || position.contains("light, dappled") || position.contains("Partial Shade") || position.contains("Lightly Dappled") || position.contains("little") || position.contains("dappled")) {
                    ...
                    halfClimbersList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(HalfClimbers.this, halfClimbersList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(HalfClimbers.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = halfClimbersList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = halfClimbersList.get(position);
