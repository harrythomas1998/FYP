...
public class HalfFerns extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_half_ferns);
        ...
        recyclerView = findViewById(R.id.halfFernsRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchHalfFerns);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("partial") || position.contains("lightly dappled") || position.contains("light, dappled") || position.contains("Partial Shade") || position.contains("Lightly Dappled") || position.contains("little") || position.contains("dappled")) {
                    ...
                    halfFernsList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(HalfFerns.this, halfFernsList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(HalfFerns.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = halfFernsList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = halfFernsList.get(position);
