...
public class HalfBedding extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_half_bedding);
        ...
        recyclerView = findViewById(R.id.halfBeddingRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchHalfBedding);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("partial") || position.contains("lightly dappled") || position.contains("light, dappled") || position.contains("Partial Shade") || position.contains("Lightly Dappled") || position.contains("little") || position.contains("dappled")) {
                    ...
                    halfBeddingList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(HalfBedding.this, halfBeddingList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(HalfBedding.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = halfBeddingList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = halfBeddingList.get(position);
