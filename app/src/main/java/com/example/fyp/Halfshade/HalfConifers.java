...
public class HalfConifers extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_half_conifers);
        ...
        recyclerView = findViewById(R.id.halfConifersRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchHalfConifers);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("partial") || position.contains("lightly dappled") || position.contains("light, dappled") || position.contains("Partial Shade") || position.contains("Lightly Dappled") || position.contains("little") || position.contains("dappled")) {
                    ...
                    halfConifersList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(HalfConifers.this, halfConifersList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(HalfConifers.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = halfConifersList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = halfConifersList.get(position);
