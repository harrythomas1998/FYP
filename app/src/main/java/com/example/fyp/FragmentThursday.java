...
public class FragmentThursday extends Fragment implements ArrayInterface, WeatherAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        WeatherAdapter weatherAdapter = new WeatherAdapter(getActivity(), thursdayData);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(weatherAdapter);
        weatherAdapter.setOnItemClickListener(FragmentThursday.this);
    ...
    public void onItemClick(int position) {
        ...
        Weather clickedWeatherItem = thursdayData.get(position);
