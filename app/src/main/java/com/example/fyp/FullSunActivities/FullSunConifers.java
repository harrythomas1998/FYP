...
public class FullSunConifers extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_sun_conifers);
        ...
        recyclerView = findViewById(R.id.fullSunConifersRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchFullSunConifers);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("full sun") || position.contains("sun") || position.contains("Full Sun") || position.contains("Sun") || position.contains("mainly sun")) {
                    ...
                    fullSunConifersList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(FullSunConifers.this, fullSunConifersList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(FullSunConifers.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = fullSunConifersList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = fullSunConifersList.get(position);
