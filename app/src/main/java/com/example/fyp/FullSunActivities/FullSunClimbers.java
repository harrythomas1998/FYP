...
public class FullSunClimbers extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_sun_climbers);
        ...
        recyclerView = findViewById(R.id.fullSunClimbersRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchFullSunClimbers);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("full sun") || position.contains("sun") || position.contains("Full Sun") || position.contains("Sun") || position.contains("mainly sun")) {
                    ...
                    fullSunClimbersList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(FullSunClimbers.this, fullSunClimbersList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(FullSunClimbers.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = fullSunClimbersList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = fullSunClimbersList.get(position);
