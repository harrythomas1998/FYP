...
public class FullSunGrasses extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_sun_grasses);
        ...
        recyclerView = findViewById(R.id.fullSunGrassesRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchFullSunGrasses);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("full sun") || position.contains("sun") || position.contains("Full Sun") || position.contains("Sun") || position.contains("mainly sun")) {
                    ...
                    fullSunGrassesList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(FullSunGrasses.this, fullSunGrassesList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(FullSunGrasses.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = fullSunGrassesList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = fullSunGrassesList.get(position);
