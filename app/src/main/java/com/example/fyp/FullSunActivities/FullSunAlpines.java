...
public class FullSunAlpines extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fun_sun_alpines);
        ...
        recyclerView = findViewById(R.id.fullSunAlpineRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchFullSunAlpines);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("full sun") || position.contains("sun") || position.contains("Full Sun") || position.contains("Sun") || position.contains("mainly sun")) {
                    ...
                    fullSunAlpinesList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(FullSunAlpines.this, fullSunAlpinesList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(FullSunAlpines.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = fullSunAlpinesList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = fullSunAlpinesList.get(position);
