...
public class FullSunHedges extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_sun_hedges);
        ...
        recyclerView = findViewById(R.id.fullSunHedgesRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchFullSunHedges);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("full sun") || position.contains("sun") || position.contains("Full Sun") || position.contains("Sun") || position.contains("mainly sun")) {
                    ...
                    fullSunHedgesList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(FullSunHedges.this, fullSunHedgesList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(FullSunHedges.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = fullSunHedgesList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = fullSunHedgesList.get(position);
