...
public class FullSunExotics extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_sun_exotics);
        ...
        recyclerView = findViewById(R.id.fullSunExoticsRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchFullSunExotics);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("full sun") || position.contains("sun") || position.contains("Full Sun") || position.contains("Sun") || position.contains("mainly sun")) {
                    ...
                    fullSunExoticsList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(FullSunExotics.this, fullSunExoticsList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(FullSunExotics.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = fullSunExoticsList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = fullSunExoticsList.get(position);
