...
public class FullSunFerns extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_sun_ferns);
        ...
        recyclerView = findViewById(R.id.fullSunFernsRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);

        search = findViewById(R.id.searchFullSunFerns);
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                if(position.contains("full sun") || position.contains("sun") || position.contains("Full Sun") || position.contains("Sun") || position.contains("mainly sun")) {
                    ...
                    fullSunFernsList.add(new Plant(name, image, position, soil, growth, care));

                }
                adapter = new PlantAdapter(FullSunFerns.this, fullSunFernsList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(FullSunFerns.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = fullSunFernsList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = fullSunFernsList.get(position);
