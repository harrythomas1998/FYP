...
public class HedgesActivity extends AppCompatActivity implements PlantAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hedges);
    ...
    public void loadJSONFromAsset() {
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                hedges.add(new Plant(name, image, position, soil, growth, care));


                adapter = new PlantAdapter(HedgesActivity.this, hedges);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(HedgesActivity.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = hedges.get(position);
