...
public class SuitableGrasses extends AppCompatActivity implements SuitablePlantsAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suitable_grasses);
        ...
        recyclerView = findViewById(R.id.suitableGrassesRecycler);
        ...
        search = findViewById(R.id.searchSuitableGrasses);
    ...
    public void loadJSONFromAsset() {
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                suitableGrassesList.add(new Plant(name, image, position, soil, growth, care));


                recyclerView.getRecycledViewPool().clear();
                adapter = new SuitablePlantsAdapter(SuitableGrasses.this, suitableGrassesList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(SuitableGrasses.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = suitableGrassesList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = suitableGrassesList.get(position);
