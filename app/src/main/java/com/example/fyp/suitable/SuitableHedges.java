...
public class SuitableHedges extends AppCompatActivity implements SuitablePlantsAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suitable_hedges);
        ...
        recyclerView = findViewById(R.id.suitableHedgesRecycler);
        ...
        search = findViewById(R.id.searchSuitableHedges);
    ...
    public void loadJSONFromAsset() {
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                suitableHedgesList.add(new Plant(name, image, position, soil, growth, care));


                recyclerView.getRecycledViewPool().clear();
                adapter = new SuitablePlantsAdapter(SuitableHedges.this, suitableHedgesList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(SuitableHedges.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = suitableHedgesList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = suitableHedgesList.get(position);
