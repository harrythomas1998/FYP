...
public class SuitableBedding extends AppCompatActivity implements SuitablePlantsAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suitable_bedding);
        ...
        recyclerView = findViewById(R.id.suitableBeddingRecycler);
        ...
        search = findViewById(R.id.searchSuitableBedding);
    ...
    public void loadJSONFromAsset() {
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                suitableBeddingList.add(new Plant(name, image, position, soil, growth, care));


                recyclerView.getRecycledViewPool().clear();
                recyclerView.setItemAnimator(null);
                adapter = new SuitablePlantsAdapter(SuitableBedding.this, suitableBeddingList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(SuitableBedding.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = suitableBeddingList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = suitableBeddingList.get(position);
