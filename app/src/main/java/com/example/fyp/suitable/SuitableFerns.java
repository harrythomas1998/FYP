...
public class SuitableFerns extends AppCompatActivity implements SuitablePlantsAdapter.OnItemClickListener, ArrayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suitable_ferns);
        ...
        recyclerView = findViewById(R.id.suitableFernsRecycler);
        ...
        search = findViewById(R.id.searchSuitableFerns);
    ...
    public void loadJSONFromAsset() {
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                suitableFernsList.add(new Plant(name, image, position, soil, growth, care));


                recyclerView.getRecycledViewPool().clear();
                adapter = new SuitablePlantsAdapter(SuitableFerns.this, suitableFernsList);
                recyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(SuitableFerns.this);
    ...
    public void onItemClick(int position) {
        ...
        Plant clickedPlantItem = suitableFernsList.get(position);
    ...
    public void onAddClick(int position) {
        ...
        Plant selectedPlant = suitableFernsList.get(position);
